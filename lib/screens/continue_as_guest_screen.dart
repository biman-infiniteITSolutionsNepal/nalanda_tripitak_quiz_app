...
class ContinueAsGuestScreen extends StatelessWidget {
  const ContinueAsGuestScreen({Key? key}) : super(key: key);
            ...
            children: [
              Column(
                children: [
                  ...
                  const SizedBox(width: 260, child: Text("You may continue as a guest by entering your name", style: TextStyle(fontSize: 20, color: Color(0xff042803)),)),
                  SizedBox(height: height / 18,),
                  TextFieldWidget("Enter your name"),
                  SizedBox(height: height / 18,),
                  RoundedButtonWidget(buttonText: "Continue", width: 350, onpressed: () => Navigator.pushNamed(context, MyRoutes.homeRoute)),
                  SizedBox(height: height / 4.23,),
